...
public abstract class BaseXContentTestCase extends ESTestCase {
    ...
    public void testReadableInstant() throws Exception {
        ...
        expected = "{'t3':'" + formatter.format(ZonedDateTime.ofInstant(t3, ZoneOffset.UTC)) + "'}";
        ...
        expected = "{'t4':'" + formatter.format(ZonedDateTime.ofInstant(t4, ZoneOffset.UTC)) + "'}";
        ...
        expected = "{'t5':'" + XContentBuilder.DEFAULT_DATE_PRINTER.format(ZonedDateTime.ofInstant(t5, ZoneOffset.UTC)) + "'}";
        ...
        expected = "{'t5':'" + formatter.format(ZonedDateTime.ofInstant(t5, ZoneOffset.UTC)) + "'}";
        ...
        expected = "{'i2':'" + formatter.format(ZonedDateTime.ofInstant(i2, ZoneOffset.UTC)) + "'}";
    ...
    public void testDate() throws Exception {
        ...
        String expected = "{'d3':'" + formatter.format(ZonedDateTime.ofInstant(Instant.ofEpochMilli(d3.getTime()), ZoneOffset.UTC)) + "'}";
