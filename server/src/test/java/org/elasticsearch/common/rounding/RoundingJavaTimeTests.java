...
public class RoundingJavaTimeTests extends ESTestCase {

    public void testUTCTimeUnitRounding() {
        RoundingJavaTime tzRounding = RoundingJavaTime.builder(RoundingJavaTime.DateTimeUnit.MONTH_OF_YEAR).build();
        ...
        tzRounding = RoundingJavaTime.builder(RoundingJavaTime.DateTimeUnit.WEEK_OF_WEEKYEAR).build();
    ...
    public void testUTCIntervalRounding() {
        RoundingJavaTime tzRounding = RoundingJavaTime.builder(TimeValue.timeValueHours(12)).build();
        ZoneId tz = ZoneOffset.UTC;
        ...
        tzRounding = RoundingJavaTime.builder(TimeValue.timeValueHours(48)).build();
        assertThat(tzRounding.round(time("2009-02-03T01:01:01")), isDate(time("2009-02-03T00:00:00.000Z"), tz));
    ...
    public void testTimeIntervalRounding() {
        ...
        RoundingJavaTime tzRounding = RoundingJavaTime.builder(TimeValue.timeValueHours(6)).timeZone(tz).build();
    ...
    public void testDayIntervalRounding() {
        ...
        RoundingJavaTime tzRounding = RoundingJavaTime.builder(TimeValue.timeValueHours(12)).timeZone(tz).build();
    ...
    public void testDayRounding() {
        ...
        RoundingJavaTime tzRounding = RoundingJavaTime.builder(RoundingJavaTime.DateTimeUnit.DAY_OF_MONTH)
        ...
        tzRounding = RoundingJavaTime.builder(RoundingJavaTime.DateTimeUnit.DAY_OF_MONTH).timeZone(tz).build();
        assertThat(tzRounding.round(time("2012-04-01T04:15:30Z")), isDate(time("2012-03-31T08:00:00Z"), tz));

        tzRounding = RoundingJavaTime.builder(RoundingJavaTime.DateTimeUnit.MONTH_OF_YEAR).timeZone(tz).build();
    ...
    public void testTimeRounding() {
        ...
        RoundingJavaTime tzRounding = RoundingJavaTime.builder(RoundingJavaTime.DateTimeUnit.HOUR_OF_DAY).timeZone(tz).build();
    ...
    public void testTimeUnitRoundingDST() {
        RoundingJavaTime tzRounding;
        // testing savings to non savings switch
        ZoneId cet = ZoneId.of("CET");
        tzRounding = RoundingJavaTime.builder(RoundingJavaTime.DateTimeUnit.HOUR_OF_DAY).timeZone(cet).build();
        ...
        RoundingJavaTime tzRounding_utc = RoundingJavaTime.builder(RoundingJavaTime.DateTimeUnit.HOUR_OF_DAY)
        ...
        RoundingJavaTime tzRounding_chg = RoundingJavaTime.builder(RoundingJavaTime.DateTimeUnit.HOUR_OF_DAY).timeZone(chg).build();
     ...
     * described in
     * {@link #assertInterval(long, long, long, RoundingJavaTime, ZoneId)}
     */
    public void testRoundingRandom() {
        for (int i = 0; i < 1000; ++i) {
            RoundingJavaTime.DateTimeUnit unit = randomFrom(RoundingJavaTime.DateTimeUnit.values());
            ZoneId tz = randomZone();
            RoundingJavaTime rounding = new RoundingJavaTime.TimeUnitRounding(unit, tz);
    ...
    public void testTimeIntervalCET_DST_End() {
        ...
        RoundingJavaTime rounding = new RoundingJavaTime.TimeIntervalRounding(interval, tz);
...
//        assertThat(rounding.round(time("2016-03-27T03:05:00+02:00")), isDate(time("2016-03-27T03:00:00+02:00"), tz));
    ...
    /**
     * randomized test on {@link Rounding.TimeIntervalRounding} with random interval and time zone offsets
     */
    ...
    public void testAmbiguousHoursAfterDSTSwitch() {
        ...
        tzRounding = RoundingJavaTime.builder(RoundingJavaTime.DateTimeUnit.HOUR_OF_DAY).timeZone(tz).build();
        ...
        // Year interval
        tzRounding = RoundingJavaTime.builder(RoundingJavaTime.DateTimeUnit.YEAR_OF_CENTURY).timeZone(tz).build();
    ...
    public void testLenientConversionDST() {
        ...
        RoundingJavaTime tzRounding = new RoundingJavaTime.TimeUnitRounding(RoundingJavaTime.DateTimeUnit.MINUTES_OF_HOUR, tz);
        RoundingJavaTime dayTzRounding = new RoundingJavaTime.TimeIntervalRounding(60000, tz);
    ...
    public void testEdgeCasesTransition() {
        {
            ...
            ZoneId tz = ZoneId.of("CET");
            RoundingJavaTime rounding = new RoundingJavaTime.TimeUnitRounding(RoundingJavaTime.DateTimeUnit.HOUR_OF_DAY, tz);
    ...
    public void testDST_Europe_Rome() {
        ...
        RoundingJavaTime rounding = new RoundingJavaTime.TimeUnitRounding(RoundingJavaTime.DateTimeUnit.DAY_OF_MONTH, tz);
    ...
    public void testDST_END_Edgecases() {
        ...
        RoundingJavaTime.DateTimeUnit timeUnit = RoundingJavaTime.DateTimeUnit.DAY_OF_MONTH;
        RoundingJavaTime rounding = new RoundingJavaTime.TimeUnitRounding(timeUnit, tz);
    ...
    private void assertInterval(long rounded, long nextRoundingValue, RoundingJavaTime rounding, int minutes,
                                       ZoneId tz) {
     ...
     */
    private void assertInterval(long rounded, long unrounded, long nextRoundingValue, RoundingJavaTime rounding, ZoneId tz) {
