...
public final class XContentBuilder implements Releasable, Flushable {
    ...
    public XContentBuilder value(Instant value, DateTimeFormatter formatter) throws IOException {
        ...
        return value(formatter.format(ZonedDateTime.ofInstant(value, ZoneOffset.UTC)));
    }
    ...
    XContentBuilder value(DateTimeFormatter formatter, long value) throws IOException {
        ensureFormatterNotNull(formatter);
        return value(formatter.format(ZonedDateTime.ofInstant(Instant.ofEpochMilli(value), ZoneOffset.UTC)));
    }
